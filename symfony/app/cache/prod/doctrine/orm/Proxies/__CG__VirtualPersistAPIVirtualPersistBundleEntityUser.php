 ...
 */
class User extends \VirtualPersistAPI\VirtualPersistBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'password', 'username', 'email', 'uuid', 'salt', 'isActive');
        }
